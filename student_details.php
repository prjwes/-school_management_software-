                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($exam_results as $result) {
                                ...
                                $exam_groups[$exam_key]['results'][] = $result;
                            }
                            
                            foreach ($exam_groups as $exam_group): 
                                $total_marks = 0;
                                $count = 0;
                                foreach ($exam_group['results'] as $result) {
                            ...
                            ?>
                                <tr>
                                    <td rowspan="<?php echo count($exam_group['results']) + 1; ?>"><?php echo htmlspecialchars($exam_group['exam_name']); ?></td>
                                    <td rowspan="<?php echo count($exam_group['results']) + 1; ?>"><?php echo formatDate($exam_group['exam_date']); ?></td>
                                </tr>
                                <?php foreach ($exam_group['results'] as $result): ?>
                                    <tr>
                                        <td>Subject</td>
                                        <td><?php echo htmlspecialchars($result['marks_obtained']); ?>/<?php echo htmlspecialchars($exam_group['total_marks']); ?></td>
                                        <td><?php echo getRubric($result['marks_obtained']); ?></td>
                                        <td rowspan="<?php echo count($exam_group['results']) + 1; ?>"><?php echo round($average, 2); ?></td>
                                        <td rowspan="<?php echo count($exam_group['results']) + 1; ?>"><?php echo $avg_rubric; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endforeach; ?>
